...
public interface ICourseService extends IGenericService<Course>, IPaginationResultService<Course> {
	...
	public PaginationResult<Course> searchBySubject(int id, String filter, String key, int page, int size);

	public PaginationResult<Course> searchByTeacher(int id, String filter, String key, int page, int size);
