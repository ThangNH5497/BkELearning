...
<link rel="stylesheet"
	href="<c:url value='/resources/manager/commons/css/category-list.css' />">
<!-- Phan noi dung trang -->
<div class="wrapper d-flex align-items-stretch">
	<jsp:include page="/WEB-INF/views/manager/admin/menu.jsp"></jsp:include>
	<jsp:include page="/WEB-INF/views/manager/commons/category-list.jsp"></jsp:include>
...
<script
	src="<c:url value='/resources/manager/commons/js/category-list.js' />"></script>
<!-- Footer -->
