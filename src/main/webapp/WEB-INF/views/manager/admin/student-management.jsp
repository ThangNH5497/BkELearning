	...
	<div id="content" class="mb-5">
		...
		<div class=" container-fluid ">
			...
			<div class="row ">
				...
				<!-- Pie Chart -->
				<div
					class="col-xl-3 col-lg-3 d-none d-lg-block card-container card-detail" id='card-detail'>
					<div class="card shadow h-100">
						<!-- Card Header - Dropdown -->
						<div
							class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									...
									<form class="form-detail" action="#" method="post"
										...
										<div class="form-group">
											<div class="form-row form-row-1 ">
												...
												<label name="password-error" class="error hidden">Nhỏ hơn 6 ký tự</label>
											</div>
											<div class="form-row form-row-1">
							...
							<div class="form-v4">
								<div class="form-v4-content">
									<form class="form-detail" id="form-exel-file">
										<h2>Thêm danh sách sinh viên từ file Excel</h2>
...
<div class="modal fade" id="modal-view" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<!--Header-->
			<div class="modal-header">
				<p class="heading lead">Thông tin sinh viên</p>
