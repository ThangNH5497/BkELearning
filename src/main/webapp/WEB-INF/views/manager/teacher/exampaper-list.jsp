...
<link rel="stylesheet"
	href="<c:url value='/resources/manager/commons/css/exampaper-list.css' />">

<!-- Phan noi dung trang -->
<div class="wrapper d-flex align-items-stretch">
	<jsp:include page="/WEB-INF/views/manager/teacher/menu.jsp"></jsp:include>
	<jsp:include page="/WEB-INF/views/manager/commons/exampaper-list.jsp"></jsp:include>
</div>
...
<script
	src="<c:url value='/resources/manager/commons/js/exampaper-list-base.js' />"></script>
<script
	src="<c:url value='/resources/manager/teacher/js/exampaper-list.js' />"></script>
<!-- Footer -->
